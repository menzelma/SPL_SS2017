...
#Create probability tables for demographic variables and compare
#Trump voters wit Non-trump voters
for(i in c(5:28)){
  nm <- names(us_data)[i]
...
#Barplot Gender Trump vs. Non-Trump voters
#Create vectors with relevant variables
...
#Plot
barplot(genAll, beside=TRUE,ylim = c(0,0.7), col=c("red", "blue"),
        legend.text=TRUE, xlab="1=Male, 2=Female", ylab="Proportion",
        main="Relative frequency of Gender of Trump vs. Non-Trump voters")

#Mosaic plot Employment status vs. Immigration
#Create vectors with relevant variables and factor levels
...
#Mosaic plot Status national Economy vs. Income
#Create vectors with relevant variables and factor levels
